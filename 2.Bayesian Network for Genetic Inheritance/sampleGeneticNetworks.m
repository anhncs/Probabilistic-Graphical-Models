...
%phenotypeFactorPar1 = phenotypeGivenCopiesFactor(alphaListThree, numAllelesThree, genotypeVarMotherCopy, genotypeVarFatherCopy, phenotypeVar);
...
sampleFactorListDecoupled1 = constructDecoupledGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
